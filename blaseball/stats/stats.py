...
determination = statclasses.build_rating(
    "determination",
    base_determination,
...
enthusiasm = statclasses.build_rating(
    "enthusiasm",
    base_enthusiasm,
    kind=statclasses.Kinds.personality
)
...
stability = statclasses.build_rating(
    "stability",
    base_stability,
    kind=statclasses.Kinds.personality
)
...
insight = statclasses.build_rating(
    "insight",
    base_insight,
    kind=statclasses.Kinds.personality
)
...
#
#
# team = Stat('team', statclasses.Kinds.character)
